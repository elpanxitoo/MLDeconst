...
export const NOTAS = {
  ...
  rosa: {nombre: "rosa", imagen: "/notas/rosa.jpg"},
  sandalo: {nombre: "sandalo", imagen: "/nota/sandalo.jpg"},
  ...
  notasAmaderadas: {nombre: "notas amaderadas", imagen: "/notas/notas-amaderadas.jpg"},
  ...
  florNaranjo: {nombre: "flor de azahar del naranjo", imagen: "/notas/flor-naranjo.jpg"},
